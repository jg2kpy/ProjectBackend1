...
const API_URL = 'http://localhost:8080/prueba/reglas-asig-puntos';
...
formulario.addEventListener("submit", async (evento) => {
    ...
    const regla = {
        limiteInferior: formulario.limiteInferior.value,
        limiteSuperior: formulario.limiteSuperior.value,
        montoEquivalencia: formulario.montoEquivalencia.value,
    };
